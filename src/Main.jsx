...
export default function Main() {
  ...
  const answers = [
    "Oi gatinha. você está disposta a responder algumas perguntas?",
              ...
              {!id ? (
                <>
                  <p className="font-semibold" align="center">"
                    <b>🤍 🤍 Todo dia é dia da minha namorada 🤍 🤍</b> - Gabriel
                  </p>

                  <p align="center">Te amo Teza, minha gatinha</p>

                  <img src={health} alt="" width={200} />

                  <p className="mt-10">Made with 🤍 by <a className="font-semibold text-red-300" href="https://www.instagram.com/donissauro/">@donissauro</a></p>
                </>
              ) : (
                <>
